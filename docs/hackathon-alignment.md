...
| Публичный repository + README | [mansurmaksut19-code/Qadam-AI](https://github.com/mansurmaksut19-code/Qadam-AI) и корневой `README.md` | `PUBLIC`, default branch `main`, repository и raw README возвращают HTTP 200 |
| Demo до 3 минут или live URL | `docs/demo-script.md`, recording checklist, live deploy | Live URL — `https://qadam-ai-techvision.staivi367.chatgpt.site` |
...
| Technical validation and iteration — 10 | Полнота MVP и история коммитов | TDD-коммиты с 164 backend + 25 frontend tests, 20 legal-retrieval queries, 9 transparent synthetic Q&A cases с 5 gates = 1.0, deterministic demo files и четыре Docker Playwright E2E: Axe, полный journey, challenge и mixed RU/KZ action |
...
- `TEAM INPUT REQUIRED`: имена/роли команды.
- Live URL уже доступен; финальная озвученная demo-запись остаётся опциональным командным усилением.
